    ...
    let url = new URI('#'),
        binds = {
            ...
            titleHover: new hoverMenu('.ui-title', [
                ...
                {
                    text: `<span class="icon" style="background-color:rgba(var(--colorFill),0.5)"><img alt="sk" src="${shikimori.origin}/assets/layouts/l-top_menu-v2/glyph.svg" height="24"></span>Открыть в Shikimori`,
